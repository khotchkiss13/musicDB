...
module Model
  ...
  class Coords 
    ...
    def init_jaxb_json_hash(_o)
      self.longitude = Float.from_json(_o['long']) unless _o['long'].nil?
      self.latitude = Float.from_json(_o['lat']) unless _o['lat'].nil?
    end
...
module Model
  ...
  class Country 
    ...
    def init_jaxb_json_hash(_o)
      self.name = String.from_json(_o['name']) unless _o['name'].nil?
      self.code = String.from_json(_o['code']) unless _o['code'].nil?
    end
...
module Model
  ...
  class Set 
    ...
    def init_jaxb_json_hash(_o)
      self.encore = Fixnum.from_json(_o['encore']) unless _o['encore'].nil?
      self.name = String.from_json(_o['name']) unless _o['name'].nil?
      if !_o['song'].nil?
        self.songs = Array.new
        _oa = _o['song']
        _oa.each { | _item | self.songs.push Fm::Setlist::Api::Model::Song.from_json(_item) }
      end
    end
...
module Model
  ...
  class Setlist 
    ...
    def init_jaxb_json_hash(_o)
      self.id = String.from_json(_o['id']) unless _o['id'].nil?
      self.eventDate = String.from_json(_o['eventDate']) unless _o['eventDate'].nil?
      self.lastUpdated = String.from_json(_o['lastUpdated']) unless _o['lastUpdated'].nil?
      self.versionId = String.from_json(_o['versionId']) unless _o['versionId'].nil?
      self.tour = String.from_json(_o['tour']) unless _o['tour'].nil?
      self.lastFmEventId = Fixnum.from_json(_o['lastFmEventId']) unless _o['lastFmEventId'].nil?
      self.artist = Fm::Setlist::Api::Model::Artist.from_json(_o['artist']) unless _o['artist'].nil?
      self.venue = Fm::Setlist::Api::Model::Venue.from_json(_o['venue']) unless _o['venue'].nil?
      if !_o['sets'].nil?
        self.sets = Array.new
        _oa = _o['sets']
        _oa.each { | _item | self.sets.push Fm::Setlist::Api::Model::Set.from_json(_item) }
      end
      self.info = String.from_json(_o['info']) unless _o['info'].nil?
      self.url = String.from_json(_o['url']) unless _o['url'].nil?
    end
...
module Model
  ...
  class User 
    ...
    def init_jaxb_json_hash(_o)
      self.flickr = String.from_json(_o['flickr']) unless _o['flickr'].nil?
      self.twitter = String.from_json(_o['twitter']) unless _o['twitter'].nil?
      self.website = String.from_json(_o['website']) unless _o['website'].nil?
      self.userId = String.from_json(_o['userId']) unless _o['userId'].nil?
      self.lastFm = String.from_json(_o['lastFm']) unless _o['lastFm'].nil?
      self.mySpace = String.from_json(_o['mySpace']) unless _o['mySpace'].nil?
      self.fullname = String.from_json(_o['fullname']) unless _o['fullname'].nil?
      self.about = String.from_json(_o['about']) unless _o['about'].nil?
      self.url = String.from_json(_o['url']) unless _o['url'].nil?
    end
...
module Model
  ...
  class Venue 
    ...
    def init_jaxb_json_hash(_o)
      self.id = String.from_json(_o['id']) unless _o['id'].nil?
      self.name = String.from_json(_o['name']) unless _o['name'].nil?
      self.city = Fm::Setlist::Api::Model::City.from_json(_o['city']) unless _o['city'].nil?
      self.url = String.from_json(_o['url']) unless _o['url'].nil?
    end
...
module Model
  ...
  class Song 
    ...
    def init_jaxb_json_hash(_o)
      self.name = String.from_json(_o['name']) unless _o['name'].nil?
      self.with = Fm::Setlist::Api::Model::Artist.from_json(_o['with']) unless _o['with'].nil?
      self.cover = Fm::Setlist::Api::Model::Artist.from_json(_o['cover']) unless _o['cover'].nil?
      self.info = String.from_json(_o['info']) unless _o['info'].nil?
    end
...
module Model
  ...
  class Result 
    ...
    def init_jaxb_json_hash(_o)
      self.total = Fixnum.from_json(_o['total']) unless _o['total'].nil?
      self.page = Fixnum.from_json(_o['page']) unless _o['page'].nil?
      self.itemsPerPage = Fixnum.from_json(_o['itemsPerPage']) unless _o['itemsPerPage'].nil?
    end
...
module Model
  ...
  class Artist 
    ...
    def init_jaxb_json_hash(_o)
      self.disambiguation = String.from_json(_o['disambiguation']) unless _o['disambiguation'].nil?
      self.mbid = String.from_json(_o['mbid']) unless _o['mbid'].nil?
      self.tmid = Fixnum.from_json(_o['tmid']) unless _o['tmid'].nil?
      self.name = String.from_json(_o['name']) unless _o['name'].nil?
      self.sortName = String.from_json(_o['sortName']) unless _o['sortName'].nil?
      self.url = String.from_json(_o['url']) unless _o['url'].nil?
    end
  ...
  class Venues < Fm::Setlist::Api::Model::Result 
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['venue'].nil?
        self.list = Array.new
        _oa = _o['venue']
        _oa.each { | _item | self.list.push Fm::Setlist::Api::Model::Venue.from_json(_item) }
      end
    end
  ...
  class Setlists < Fm::Setlist::Api::Model::Result 
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['setlist'].nil?
        self.list = Array.new
        _oa = _o['setlist']
        _oa.each { | _item | self.list.push Fm::Setlist::Api::Model::Setlist.from_json(_item) }
      end
    end
  ...
  class Countries < Fm::Setlist::Api::Model::Result 
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['country'].nil?
        self.list = Array.new
        _oa = _o['country']
        _oa.each { | _item | self.list.push Fm::Setlist::Api::Model::Country.from_json(_item) }
      end
    end
  ...
  class Cities < Fm::Setlist::Api::Model::Result 
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['cities'].nil?
        self.list = Array.new
        _oa = _o['cities']
        _oa.each { | _item | self.list.push Fm::Setlist::Api::Model::City.from_json(_item) }
      end
    end
  ...
  class Artists < Fm::Setlist::Api::Model::Result 
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['artist'].nil?
        self.list = Array.new
        _oa = _o['artist']
        _oa.each { | _item | self.list.push Fm::Setlist::Api::Model::Artist.from_json(_item) }
      end
    end
